...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {基于非交互式零知识证明的程序验证的隐私保障},
    en / title           = {Privacy-Preserving Programing Verification via Non-Interactive Zero-Knowledge Proofs},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {程序验证, 符号执行, 零知识证明, 布尔可满足性问题, 普朗克, 零知识证明虚拟机},
    en / keywords        = {Programing Verification, Symbolic Execution, Zero-Knowledge Proof, SAT, PLONKish,zkVM},
    %
    % 姓名
    %
    zh / author          = {魏浩宇},
    ...
    %
    zh / supervisor      = {李国强教授},
    en / supervisor      = {Prof.\ GuoQiang Li},
    %
    % 副指导教师
    %
    ...
    %
    zh / department      = {计算机系},
    en / department      = {Depart of computer science},
    %
    % 专业
    %
    zh / major           = {计算机科学与技术},
